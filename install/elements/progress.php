...
<div class="flex">
    <div class="w-1/4">
      <div class="relative mb-2">
        <div class="w-10 h-10 mx-auto <?php echo stepColor(1); ?> rounded-full text-lg text-white flex items-center">
      ...
      <div class="text-xs text-center md:text-base">Database Setup</div>
    </div>
      ...
      <div class="relative mb-2">
        <div class="absolute flex align-center items-center align-middle content-center" style="width: calc(100% - 2.5rem - 1rem); top: 50%; transform: translate(-50%, -50%)">
          <div class="w-full bg-gray-200 rounded items-center align-middle align-center flex-1">
            <div class="w-0 bg-green-300 py-1 rounded" <?php if(STEP >= 2) { echo 'style="width: 100%;"'; } ?>></div>
          </div>
        </div>

        <div class="w-10 h-10 mx-auto <?php echo stepColor(2); ?> rounded-full text-lg text-white flex items-center">
          <span class="text-center <?php if(STEP >= 2) { echo 'text-white'; } else { echo 'text-gray-600'; } ?> w-full">
            <svg class="w-full fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24">
    ...
    <div class="w-1/4">
      <div class="relative mb-2">
        <div class="absolute flex align-center items-center align-middle content-center" style="width: calc(100% - 2.5rem - 1rem); top: 50%; transform: translate(-50%, -50%)">
          <div class="w-full bg-gray-200 rounded items-center align-middle align-center flex-1">
            <div class="w-0 bg-green-300 py-1 rounded" <?php if(STEP >= 3) { echo 'style="width: 100%;"'; } ?>></div>
          </div>
        </div>
